    ...
    $.widget('custom.SwatchRenderer', {
        options: {
            classes: {
                ...
                // attributeInput: 'swatch-input form-control',
                optionClass: 'swatch-option',
                selectClass: 'swatch-select',
                // selectClass: 'swatch-select form-control',
        ...
        _RenderSwatchSelect: function (config, chooseText) {
            ...
            var html =
                '<select class="form-control ' + this.options.classes.selectClass + ' ' + config.code + '">' +
        ...
        _RenderFormInput: function (config) {
            return '<input class="form-control ' + this.options.classes.attributeInput + '" ' +
